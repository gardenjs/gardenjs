<div class="topbar">
  <div class="topbar__inner">
    ...
    <div class="topbar__nav">
      <div class="dropdown">
        <button class="dropdown__btn">Themes <svg class="label-first" xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24"><path d="M16.59 8.59L12 13.17 7.41 8.59 6 10l6 6 6-6z"/></svg></button>
      ...
      <button class="switch-mode" on:click={toggleDarkmode} >
        {#if dark}
